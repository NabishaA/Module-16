...
![image](https://github.com/user-attachments/assets/25ba2d67-719c-44e9-8df3-3549b45b6a80)

## RESULT

The python program to construct an **AVL tree** and print the nodes of it using the appropriate packages and built-in function has been executed and verified successfully.
