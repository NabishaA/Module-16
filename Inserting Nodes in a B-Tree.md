...
![image](https://github.com/user-attachments/assets/f524d0ce-d574-4018-8644-962acb6176d2)

## RESULT

The python function `def insert(self, k):` to insert the nodes in a **B-Tree** has been executed and verified successfully.
